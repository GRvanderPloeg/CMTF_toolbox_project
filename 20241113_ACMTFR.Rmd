...
```{r run ACMTF}
model_ACMTF = acmtf_opt(Z, numComponents=5, abs_tol=1e-6, rel_tol=1e-6, nstart=5, numCores=5)
```
...
```{r run ACMTF YAS}
model_ACMTF_YAS = acmtf_opt(Z_YAS, numComponents=5, abs_tol=1e-6, rel_tol=1e-6, nstart=5, numCores=5)
```

# ACMTFR
```{r run ACMTFR}
model_ACMTFR = acmtfr_opt(Z, Y, numComponents=5, pi=0.9, abs_tol=1e-6, rel_tol=1e-6, nstart=5, numCores=5, allOutput=TRUE)
```
...
# ACMTF YAS
f = cbind(model_ACMTF_YAS$Fac[[1]][,1], a_global) %>% as_tibble() %>% ggplot(aes(x=a_global,y=V1)) + geom_point() + ggtitle("Common") + xlab("Real scores") + ylab("ACMTF-YAS")
g = cbind(model_ACMTF_YAS$Fac[[1]][,2], a_local) %>% as_tibble() %>% ggplot(aes(x=a_local,y=V1)) + geom_point() + ggtitle("Local") + xlab("Real scores") + ylab("ACMTF-YAS")
h = cbind(model_ACMTF_YAS$Fac[[1]][,3], a_distinct1) %>% as_tibble() %>% ggplot(aes(x=a_distinct1,y=V1)) + geom_point() + ggtitle("Distinct X1") + xlab("Real scores") + ylab("ACMTF-YAS")
i = cbind(model_ACMTF_YAS$Fac[[1]][,4], a_distinct2) %>% as_tibble() %>% ggplot(aes(x=a_distinct2,y=V1)) + geom_point() + ggtitle("Distinct X2") + xlab("Real scores") + ylab("ACMTF-YAS")
j = cbind(model_ACMTF_YAS$Fac[[1]][,5], a_distinct3) %>% as_tibble() %>% ggplot(aes(x=a_distinct3,y=V1)) + geom_point() + ggtitle("Distinct X3") + xlab("Real scores") + ylab("ACMTF-YAS")

# ACMTFR
k = cbind(model_ACMTFR$Fac[[1]][,1], a_global) %>% as_tibble() %>% ggplot(aes(x=a_global,y=V1)) + geom_point() + ggtitle("Common") + xlab("Real scores") + ylab("ACMTFR")
l = cbind(model_ACMTFR$Fac[[1]][,4], a_local) %>% as_tibble() %>% ggplot(aes(x=a_local,y=V1)) + geom_point() + ggtitle("Local") + xlab("Real scores") + ylab("ACMTFR")
m = cbind(model_ACMTFR$Fac[[1]][,3], a_distinct1) %>% as_tibble() %>% ggplot(aes(x=a_distinct1,y=V1)) + geom_point() + ggtitle("Distinct X1") + xlab("Real scores") + ylab("ACMTFR")
n = cbind(model_ACMTFR$Fac[[1]][,2], a_distinct2) %>% as_tibble() %>% ggplot(aes(x=a_distinct2,y=V1)) + geom_point() + ggtitle("Distinct X2") + xlab("Real scores") + ylab("ACMTFR")
o = cbind(model_ACMTFR$Fac[[1]][,3], a_distinct3) %>% as_tibble() %>% ggplot(aes(x=a_distinct3,y=V1)) + geom_point() + ggtitle("Distinct X3") + xlab("Real scores") + ylab("ACMTFR")
