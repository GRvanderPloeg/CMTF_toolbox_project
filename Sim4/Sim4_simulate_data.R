...
# Save sim
saveRDS(X1_final@data, "./Sim4/Sim4_X1.RDS")
saveRDS(X2_final@data, "./Sim4/Sim4_X2.RDS")
saveRDS(X3_final@data, "./Sim4/Sim4_X3.RDS")
...
for(i in 1:length(noises)){
  ...
  # Save sim
  saveRDS(Y_final@data, paste0("./Sim4/Sim4_Y_", noiseOnY, ".RDS"))
}
