...
# Save sim
saveRDS(X1_final, "./Sim1e/Sim1e_X1_Y_inside.RDS")
saveRDS(X2_final, "./Sim1e/Sim1e_X2_Y_inside.RDS")
saveRDS(X3_final, "./Sim1e/Sim1e_X3_Y_inside.RDS")
saveRDS(Y_final, "./Sim1e/Sim1e_Y_Y_inside.RDS")

allLoadings = list(scores, loadings, timeLoadings)
saveRDS(allLoadings, "./Sim1e/Sim1e_input_loadings_Y_inside.RDS")
...
saveRDS(parameters, "./Sim1e/Sim1e_parameters_Y_inside.RDS")
