...
for(i in 1:length(noises)){
  ...
  Ynoise = Y + noiseY_final
  Ynorm = Ynoise / norm(Ynoise, "2")
  Y_final = Ysize * Ynorm
  Y_final = as.tensor(Y_final)

  saveRDS(Y_final, paste0("./Sim2b/Sim2b_Y_Y_inside_", noiseOnY, ".RDS"))
}

# Save sim
saveRDS(X1_final, "./Sim2b/Sim2b_X1_Y_inside.RDS")
saveRDS(X2_final, "./Sim2b/Sim2b_X2_Y_inside.RDS")
saveRDS(X3_final, "./Sim2b/Sim2b_X3_Y_inside.RDS")
