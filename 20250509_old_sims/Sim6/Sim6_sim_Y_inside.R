...
# Sizes of the blocks - biologically sensible
numSubjects = 150
numFeatures = 100
numTimepoints = 4
...
# Save sim
saveRDS(X1_final, "./Sim6/Sim6_X1_Y_inside.RDS")
saveRDS(X2_final, "./Sim6/Sim6_X2_Y_inside.RDS")
saveRDS(X3_final, "./Sim6/Sim6_X3_Y_inside.RDS")
saveRDS(Y_final, "./Sim6/Sim6_Y_Y_inside.RDS")

allLoadings = list(scores, loadings, timeLoadings)
saveRDS(allLoadings, "./Sim6/Sim6_input_loadings_Y_inside.RDS")
...
saveRDS(parameters, "./Sim6/Sim6_parameters_Y_inside.RDS")
