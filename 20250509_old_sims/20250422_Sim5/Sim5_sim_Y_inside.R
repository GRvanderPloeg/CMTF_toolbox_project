...
# Save sim
saveRDS(X1_final, "./Sim5/Sim5_X1_Y_inside.RDS")
saveRDS(X2_final, "./Sim5/Sim5_X2_Y_inside.RDS")
saveRDS(X3_final, "./Sim5/Sim5_X3_Y_inside.RDS")
saveRDS(Y_final, "./Sim5/Sim5_Y_Y_inside.RDS")

allLoadings = list(scores, loadings, timeLoadings)
saveRDS(allLoadings, "./Sim5/Sim5_input_loadings_Y_inside.RDS")
...
saveRDS(parameters, "./Sim5/Sim5_parameters_Y_inside.RDS")
