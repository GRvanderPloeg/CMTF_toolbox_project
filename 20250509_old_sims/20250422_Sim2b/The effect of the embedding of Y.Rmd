...
Y_final = readRDS("./Sim2b_Y_Y_inside_1.RDS") # This is different every time
```
...
```{r check cv outcome}
# cv_01 = readRDS("./Sim2b_ACMTFR_model_selection_result0.1.RDS") # might be 5+
# cv_02 = readRDS("./Sim2b_ACMTFR_model_selection_result0.2.RDS") # might be 5+
# cv_03 = readRDS("./Sim2b_ACMTFR_model_selection_result0.3.RDS") # might be 5+
# cv_04 = readRDS("./Sim2b_ACMTFR_model_selection_result0.4.RDS") # might be 5+
# cv_05 = readRDS("./Sim2b_ACMTFR_model_selection_result0.5.RDS") # 5 comps
# cv_06 = readRDS("./Sim2b_ACMTFR_model_selection_result0.6.RDS") # 
# cv_07 = readRDS("./Sim2b_ACMTFR_model_selection_result0.7.RDS") # 
# cv_08 = readRDS("./Sim2b_ACMTFR_model_selection_result0.8.RDS") # 
# cv_09 = readRDS("./Sim2b_ACMTFR_model_selection_result0.9.RDS") # 5 comps but check degen
# cv_095 = readRDS("./Sim2b_ACMTFR_model_selection_result0.95.RDS") # 5 comps but check degen
# cv_1 should be 7 components
```
