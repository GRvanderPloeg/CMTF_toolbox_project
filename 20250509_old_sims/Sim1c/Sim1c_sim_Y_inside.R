...
# Save sim
saveRDS(X1_final, "./Sim1c/Sim1c_X1_Y_inside.RDS")
saveRDS(X2_final, "./Sim1c/Sim1c_X2_Y_inside.RDS")
saveRDS(X3_final, "./Sim1c/Sim1c_X3_Y_inside.RDS")
saveRDS(Y_final, "./Sim1c/Sim1c_Y_Y_inside.RDS")

allLoadings = list(scores, loadings, timeLoadings)
saveRDS(allLoadings, "./Sim1c/Sim1c_input_loadings_Y_inside.RDS")
...
saveRDS(parameters, "./Sim1c/Sim1c_parameters_Y_inside.RDS")
