...
# Load data
X1_final = readRDS("./Sim5c_X1_Y_inside.RDS")
X2_final = readRDS("./Sim5c_X2_Y_inside.RDS")
X3_final = readRDS("./Sim5c_X3_Y_inside.RDS")
Y_final = readRDS("./Sim5c_Y_Y_inside.RDS")
...
# Save model
saveRDS(models, "Sim5c_ACMTFR_CV_Y_inside.RDS")
saveRDS(simSettings, "Sim5c_ACMTFR_CV_params_Y_inside.RDS")
