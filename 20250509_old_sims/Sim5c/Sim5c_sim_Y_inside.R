...
# Save sim
saveRDS(X1_final, "./Sim5c/Sim5c_X1_Y_inside.RDS")
saveRDS(X2_final, "./Sim5c/Sim5c_X2_Y_inside.RDS")
saveRDS(X3_final, "./Sim5c/Sim5c_X3_Y_inside.RDS")
saveRDS(Y_final, "./Sim5c/Sim5c_Y_Y_inside.RDS")

allLoadings = list(scores, loadings, timeLoadings)
saveRDS(allLoadings, "./Sim5c/Sim5c_input_loadings_Y_inside.RDS")
...
saveRDS(parameters, "./Sim5c/Sim5c_parameters_Y_inside.RDS")
