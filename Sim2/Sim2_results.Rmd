...
# Load data
Y_final = as.matrix(readRDS("./20250619_run/Sim2_Y.RDS"))
...
for(i in 1:length(deltas)){
  ...
  # Load data
  X1_final = readRDS(paste0("./20250619_run/Sim2_X1_", delta, ".RDS"))
  X2_final = readRDS(paste0("./20250619_run/Sim2_X2_", delta, ".RDS"))
  X3_final = readRDS(paste0("./20250619_run/Sim2_X3_", delta, ".RDS"))
  ...
  # Load models
  acmtfr_models01 = readRDS(paste0("./20250619_run/Sim2_ACMTFR_model_01_", delta, ".RDS"))
  acmtfr_models02 = readRDS(paste0("./20250619_run/Sim2_ACMTFR_model_02_", delta, ".RDS"))
  acmtfr_models03 = readRDS(paste0("./20250619_run/Sim2_ACMTFR_model_03_", delta, ".RDS"))
  acmtfr_models04 = readRDS(paste0("./20250619_run/Sim2_ACMTFR_model_04_", delta, ".RDS"))
  acmtfr_models05 = readRDS(paste0("./20250619_run/Sim2_ACMTFR_model_05_", delta, ".RDS"))
  acmtfr_models06 = readRDS(paste0("./20250619_run/Sim2_ACMTFR_model_06_", delta, ".RDS"))
  acmtfr_models07 = readRDS(paste0("./20250619_run/Sim2_ACMTFR_model_07_", delta, ".RDS"))
  acmtfr_models08 = readRDS(paste0("./20250619_run/Sim2_ACMTFR_model_08_", delta, ".RDS"))
  acmtfr_models09 = readRDS(paste0("./20250619_run/Sim2_ACMTFR_model_09_", delta, ".RDS"))
  acmtfr_models10 = readRDS(paste0("./20250619_run/Sim2_ACMTFR_model_10_", delta, ".RDS"))
...
c=deltaTCC_A %>%
  ...
  geom_tile(col="black") +
  scale_fill_gradient2(
        name=expression(paste("|",phi(bold(a)[L13],tilde(bold(a))[L13]),"|")),
        low = "#762A83",
        high = "#1B7837",
        midpoint = 0,
        limits = c(-1, 1),
...
d=deltaTCC_B1 %>%
  ...
  geom_tile(col="black") +
  scale_fill_gradient2(
        name=expression(paste("|",phi(bold(b)[L13]^{(1)},tilde(bold(b))[L13]^{(1)}),"|")),
        low = "#762A83",
        high = "#1B7837",
        midpoint = 0,
        limits = c(-1, 1),
...
e=deltaTCC_C1 %>%
  ...
  geom_tile(col="black") +
  scale_fill_gradient2(
        name=expression(paste("|",phi(bold(c)[L13]^{(1)},tilde(bold(c))[L13]^{(1)}),"|")),
        low = "#762A83",
        high = "#1B7837",
        midpoint = 0,
        limits = c(-1, 1),
...
f=deltaTCC_B3 %>%
  ...
  geom_tile(col="black") +
  scale_fill_gradient2(
        name=expression(paste("|",phi(bold(b)[L13]^{(3)},tilde(bold(b))[L13]^{(3)}),"|")),
        low = "#762A83",
        high = "#1B7837",
        midpoint = 0,
        limits = c(-1, 1),
...
g=deltaTCC_C3 %>%
  ...
  geom_tile(col="black") +
  scale_fill_gradient2(
        name=expression(paste("|",phi(bold(c)[L13]^{(3)},tilde(bold(c))[L13]^{(3)}),"|")),
        low = "#762A83",
        high = "#1B7837",
        midpoint = 0,
        limits = c(-1, 1),
