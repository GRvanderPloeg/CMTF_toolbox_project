...
pis   = c(0.9, 0.95)
simSettings = cbind(rep(betas, each=2), rep(pis, 9))
...
# Save model
saveRDS(models, "Sim2_ACMTFR_CV_Y_inside_addon.RDS")
saveRDS(simSettings, "Sim2_ACMTFR_CV_params_Y_inside_addon.RDS")
