...
for(i in 1:length(simSettings)){
  ...
  # Save sim
  saveRDS(X1_final, paste0("./Sim1d/Sim1d_X1_Y_inside_", numSubjects, "_", numFeatures, "_", numTimepoints, ".RDS"))
  saveRDS(X2_final, paste0("./Sim1d/Sim1d_X2_Y_inside_", numSubjects, "_", numFeatures, "_", numTimepoints, ".RDS"))
  saveRDS(X3_final, paste0("./Sim1d/Sim1d_X3_Y_inside_", numSubjects, "_", numFeatures, "_", numTimepoints, ".RDS"))

  allLoadings = list(scores, loadings, timeLoadings)
  saveRDS(allLoadings, paste0("./Sim1d/Sim1d_input_loadings_Y_inside_", numSubjects, "_", numFeatures, "_", numTimepoints, ".RDS"))
  ...
  saveRDS(parameters, paste0("./Sim1d/Sim1d_parameters_Y_inside_", numSubjects, "_", numFeatures, "_", numTimepoints, ".RDS"))
}
