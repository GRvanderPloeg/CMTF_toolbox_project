...
# Load data
X1_final = readRDS("./Sim3_X1_Y_inside.RDS")
X2_final = readRDS("./Sim3_X2_Y_inside.RDS")
X3_final = readRDS("./Sim3_X3_Y_inside.RDS")
Y_final = readRDS("./Sim3_Y_Y_inside.RDS")
...
# Save model
saveRDS(models, "Sim3_ACMTFR_CV_Y_inside.RDS")
saveRDS(simSettings, "Sim3_ACMTFR_CV_params_Y_inside.RDS")
