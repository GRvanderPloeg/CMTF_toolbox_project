...
# Save sim
saveRDS(X1_final, "./Sim1/Sim1_X1_Y_inside.RDS")
saveRDS(X2_final, "./Sim1/Sim1_X2_Y_inside.RDS")
saveRDS(X3_final, "./Sim1/Sim1_X3_Y_inside.RDS")
saveRDS(Y_final, "./Sim1/Sim1_Y_Y_inside.RDS")

allLoadings = list(scores, loadings, timeLoadings)
saveRDS(allLoadings, "./Sim1/Sim1_input_loadings_Y_inside.RDS")
...
saveRDS(parameters, "./Sim1/Sim1_parameters_Y_inside.RDS")
