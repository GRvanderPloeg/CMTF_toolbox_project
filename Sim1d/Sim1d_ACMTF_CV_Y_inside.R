...
saveRDS(models, paste0("Sim1d_ACMTF_CV_models_Y_inside", "_", numSubjects, "_", numFeatures, "_", numTimepoints, ".RDS"))
saveRDS(betas, paste0("Sim1d_ACMTF_CV_params_Y_inside", "_", numSubjects, "_", numFeatures, "_", numTimepoints, ".RDS"))
