...
# Run model
models = acmtf_opt(Z, numComponents=7, beta=c(1e-3,1e-3,1e-3), abs_tol=1e-10, rel_tol=1e-10, nstart=100, numCores=20, allOutput=TRUE)

# Save model
saveRDS(models, "20241203_ACMTF_models_Y_inside.RDS")
