...
for(i in 1:length(pis)){
  piValue = pis[i]
  result=CMTFtoolbox::ACMTFR_modelSelection(datasets,modes,as.matrix(Y_final@data),maxNumComponents=10, pi=piValue,nstart=20,cvFolds=10,normalize=FALSE,method="L-BFGS",numCores=parallel::detectCores())
