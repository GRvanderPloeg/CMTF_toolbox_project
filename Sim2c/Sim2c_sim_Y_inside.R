...
Y = rho1 * a_global1 + rho2 * a_global2 + rho3 * a_distinct1 + rho4 * a_distinct2
...
# Save sim
saveRDS(X1_final, "./Sim2c/Sim2c_X1_Y_inside.RDS")
saveRDS(X2_final, "./Sim2c/Sim2c_X2_Y_inside.RDS")
saveRDS(X3_final, "./Sim2c/Sim2c_X3_Y_inside.RDS")
saveRDS(Y_final, "./Sim2c/Sim2c_Y_Y_inside.RDS")

allLoadings = list(scores, loadings, timeLoadings)
saveRDS(allLoadings, "./Sim2c/Sim2c_input_loadings_Y_inside.RDS")
...
saveRDS(parameters, "./Sim2c/Sim2c_parameters_Y_inside.RDS")
