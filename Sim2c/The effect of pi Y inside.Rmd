...
inputLoadings = readRDS("./Sim2c_input_loadings_Y_inside.RDS")
...
```{r load ACMTF models}
ACMTFR_CV_models = readRDS("./Sim2c_ACMTFR_CV_Y_inside.RDS")
ACMTFR_CV_params = readRDS("./Sim2c_ACMTFR_CV_params_Y_inside.RDS")
```
...
Yreal = readRDS("./Sim2c_Y_Y_inside.RDS")
Yreal = Yreal@data
