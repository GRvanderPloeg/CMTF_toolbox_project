...
result_Tensor_Tensor = array(0L, c(12, length(CMTF_010)))
for(i in 1:length(CMTF_010)){
  result_Tensor_Tensor[1,i] = FMS_to_simulation(inputFac, CMTF_010[[i]]$Fac, modes, componentSizes)
  result_Tensor_Tensor[2,i] = FMS_to_simulation(inputFac, CMTF_010_over[[i]]$Fac, modes, componentSizes)

  result_Tensor_Tensor[3,i] = FMS_to_simulation(inputFac, CMTF_025[[i]]$Fac, modes, componentSizes)
  result_Tensor_Tensor[4,i] = FMS_to_simulation(inputFac, CMTF_025_over[[i]]$Fac, modes, componentSizes)

  result_Tensor_Tensor[5,i] = FMS_to_simulation(inputFac, CMTF_035[[i]]$Fac, modes, componentSizes)
  result_Tensor_Tensor[6,i] = FMS_to_simulation(inputFac, CMTF_035_over[[i]]$Fac, modes, componentSizes)

  result_Tensor_Tensor[7,i] = FMS_to_simulation(inputFac, CMTF_010_norm[[i]]$Fac, modes, componentSizes_norm)
  result_Tensor_Tensor[8,i] = FMS_to_simulation(inputFac, CMTF_010_norm_over[[i]]$Fac, modes, componentSizes_norm)

  result_Tensor_Tensor[9,i] = FMS_to_simulation(inputFac, CMTF_025_norm[[i]]$Fac, modes, componentSizes_norm)
  result_Tensor_Tensor[10,i] = FMS_to_simulation(inputFac, CMTF_025_norm_over[[i]]$Fac, modes, componentSizes_norm)

  result_Tensor_Tensor[11,i] = FMS_to_simulation(inputFac, CMTF_035_norm[[i]]$Fac, modes, componentSizes_norm)
  result_Tensor_Tensor[12,i] = FMS_to_simulation(inputFac, CMTF_035_norm[[i]]$Fac, modes, componentSizes_norm)
}
