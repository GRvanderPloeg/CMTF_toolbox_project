...
NPLS_milk = NPLStoolbox::triPLS1(processedMilk$data, Ynorm, 1) # 2 not interpretable
...
NPLS_milkMetab = NPLStoolbox::triPLS1(processedMilkMetab$data, Ynorm, 1)
```
...
```{r check best pi}
CV_pi_models = readRDS("./CV_WHZ_pi_models.RDS")
...
df %>% ggplot(aes(x=pi,y=varExpY)) + geom_line() + geom_point() + xlab(expression(pi)) + ylab("Variance explained in Y (%)")
```

```{r check CV}
WHZ1_small = readRDS("./CV_small_WHZ_0.8.RDS")
WHZ2_small = readRDS("./CV_small_WHZ_0.825.RDS")
WHZ3_small = readRDS("./CV_small_WHZ_0.85.RDS")
WHZ4_small = readRDS("./CV_small_WHZ_0.875.RDS")
WHZ5_small = readRDS("./CV_small_WHZ_0.9.RDS")
WHZ6_small = readRDS("./CV_small_WHZ_0.925.RDS")
WHZ7_small = readRDS("./CV_small_WHZ_0.95.RDS")
WHZ8_small = readRDS("./CV_small_WHZ_0.975.RDS")
...
```
```{r find best model intermediate}
model_whz851 = acmtfr_opt(Z, Ynorm, 1, pi=0.851, method="L-BFGS", nstart=10, numCores=10)
model_whz852 = acmtfr_opt(Z, Ynorm, 1, pi=0.852, method="L-BFGS", nstart=10, numCores=10)
model_whz853 = acmtfr_opt(Z, Ynorm, 1, pi=0.853, method="L-BFGS", nstart=10, numCores=10)
model_whz854 = acmtfr_opt(Z, Ynorm, 1, pi=0.854, method="L-BFGS", nstart=10, numCores=10)
model_whz855 = acmtfr_opt(Z, Ynorm, 1, pi=0.855, method="L-BFGS", nstart=10, numCores=10)
model_whz856 = acmtfr_opt(Z, Ynorm, 1, pi=0.856, method="L-BFGS", nstart=10, numCores=10)
model_whz857 = acmtfr_opt(Z, Ynorm, 1, pi=0.857, method="L-BFGS", nstart=10, numCores=10)
model_whz858 = acmtfr_opt(Z, Ynorm, 1, pi=0.858, method="L-BFGS", nstart=10, numCores=10)
model_whz859 = acmtfr_opt(Z, Ynorm, 1, pi=0.859, method="L-BFGS", nstart=10, numCores=10)
model_whz86 = acmtfr_opt(Z, Ynorm, 1, pi=0.86, method="L-BFGS", nstart=10, numCores=10)
# iter = do.call(rbind, lapply(ACMTFR_models, FUN=function(x){x$iter}))
# loss = do.call(rbind, lapply(ACMTFR_models, FUN=function(x){x$f}))
# varExpX = do.call(rbind, lapply(ACMTFR_models, FUN=function(x){x$varExp}))
# varExpY = do.call(rbind, lapply(ACMTFR_models, FUN=function(x){x$varExpY}))
...
# 
# bestIndex = 69
# model_whz851 = ACMTFR_models[[bestIndex]]
```
...
methods = c("pi=0.80", "pi=0.85", "pi=0.852", "pi=0.854", "pi=0.856", "pi=0.858", "pi=0.86", "pi=0.90", "pi=1")

cbind(model_whz80$Fac[[8]], model_whz85$Fac[[8]], model_whz852$Fac[[8]], model_whz854$Fac[[8]], model_whz856$Fac[[8]], model_whz858$Fac[[8]], model_whz86$Fac[[8]], model_whz90$Fac[[8]], model_ACMTF$Fac[[8]]) %>%
  t() %>%
  as_tibble() %>%
  mutate(model=1:9) %>%
  pivot_longer(-model) %>% 
...
df = cbind(NPLS_faecal$Fac[[1]], NPLS_milk$Fac[[1]], NPLS_milkMetab$Fac[[1]], model_whz80$Fac[[1]], model_whz85$Fac[[1]], model_whz852$Fac[[1]], model_whz854$Fac[[1]], model_whz856$Fac[[1]], model_whz858$Fac[[1]], model_whz86$Fac[[1]], model_whz90$Fac[[1]], model_ACMTF$Fac[[1]])
...
methods = c("NPLS Faecal", "NPLS Milk", "NPLS MilkMetab", "pi=0.80", "pi=0.85", "pi=0.852", "pi=0.854", "pi=0.856", "pi=0.858", "pi=0.86", "pi=0.90", "pi=1")
...
df = cbind(NPLS_faecal$Fac[[2]], model_whz80$Fac[[2]], model_whz85$Fac[[2]], model_whz852$Fac[[2]], model_whz854$Fac[[2]], model_whz856$Fac[[2]], model_whz858$Fac[[2]], model_whz86$Fac[[2]], model_whz90$Fac[[2]], model_ACMTF$Fac[[2]])
...
methods = c("NPLS Faecal", "pi=0.80", "pi=0.85", "pi=0.852", "pi=0.854", "pi=0.856", "pi=0.858", "pi=0.86", "pi=0.90", "pi=1")
...
df = cbind(NPLS_milk$Fac[[2]], model_whz80$Fac[[4]], model_whz85$Fac[[4]], model_whz852$Fac[[4]], model_whz854$Fac[[4]], model_whz856$Fac[[4]], model_whz858$Fac[[4]], model_whz86$Fac[[4]], model_whz90$Fac[[4]], model_ACMTF$Fac[[4]])
...
methods = c("NPLS Milk", "pi=0.80", "pi=0.85", "pi=0.852", "pi=0.854", "pi=0.856", "pi=0.858", "pi=0.86", "pi=0.90", "pi=1")
...
df = cbind(NPLS_milkMetab$Fac[[2]], model_whz80$Fac[[6]], model_whz85$Fac[[6]], model_whz852$Fac[[6]], model_whz854$Fac[[6]], model_whz856$Fac[[6]], model_whz858$Fac[[6]], model_whz86$Fac[[6]], model_whz90$Fac[[6]], model_ACMTF$Fac[[6]])
...
methods = c("NPLS Metab", "pi=0.80", "pi=0.85", "pi=0.852", "pi=0.854", "pi=0.856", "pi=0.858", "pi=0.86", "pi=0.90", "pi=1")
