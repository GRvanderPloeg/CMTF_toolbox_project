...
cv_outcome90 = readRDS("./CV_small_WHZ_0.9.RDS") # one component, does not explain Y
cv_outcome90$plots$overview
rm(cv_outcome90)

# we need to check in between here

cv_outcome85 = readRDS("./CV_small_WHZ_0.85.RDS") # one component, does explain Y
cv_outcome85$plots$overview
rm(cv_outcome85)

cv_outcome80 = readRDS("./CV_small_WHZ_0.8.RDS") # one very bad component
cv_outcome80$plots$overview
rm(cv_outcome80)

cv_outcome75 = readRDS("./CV_small_WHZ_0.75.RDS") # one very bad component
cv_outcome75$plots$overview
rm(cv_outcome75)

cv_outcome50 = readRDS("./CV_small_WHZ_0.5.RDS") # one very bad component
cv_outcome50$plots$overview
rm(cv_outcome50)

cv_outcome25 = readRDS("./CV_small_WHZ_0.25.RDS") # awful, one component, not worth discussing
