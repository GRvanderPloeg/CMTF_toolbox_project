...
model = CMTFtoolbox::acmtfr_opt(Z, Ynorm, numComponents=2, pi=0.875, nstart=100, numCores=parallel::detectCores(), allOutput=TRUE)
saveRDS(model, "./ACMTFR_model_bmi875.RDS")
