...
cbind(model_bmi80$Yhat, model_bmi825$Yhat, model_bmi85$Yhat, model_bmi875$Yhat, model_bmi90$Yhat, Ynorm) %>%
  as_tibble() %>%
  pivot_longer(-Ynorm) %>%
  ...
  ylab("Yhat") +
  scale_color_manual(name="Model", labels=c("ACMTF-R (pi=0.80)", "ACMTF-R (pi=0.825)", "ACMTF-R (pi=0.85)", "ACMTF-R (pi=0.875)", "ACMTF-R (pi=0.90)"), values=hue_pal()(5))
```
