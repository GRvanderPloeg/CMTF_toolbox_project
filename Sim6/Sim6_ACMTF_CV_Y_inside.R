...
# Load data
X1_final = readRDS("./Sim6_X1_Y_inside.RDS")
X2_final = readRDS("./Sim6_X2_Y_inside.RDS")
X3_final = readRDS("./Sim6_X3_Y_inside.RDS")
...
saveRDS(models, "Sim6_ACMTF_CV_models_Y_inside.RDS")
saveRDS(betas, "Sim6_ACMTF_CV_params_Y_inside.RDS")
