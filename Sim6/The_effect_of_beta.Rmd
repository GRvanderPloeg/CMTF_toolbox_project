...
inputLoadings = readRDS("./Sim6_input_loadings_Y_inside.RDS")
...
```{r load ACMTF models}
ACMTF_CV_models = readRDS("./Sim6_ACMTF_CV_models_Y_inside.RDS")
ACMTF_CV_params = readRDS("./Sim6_ACMTF_CV_params_Y_inside.RDS")
```
