...
saveRDS(X2_final, "./Sim3/Sim3_X2_Y_outside.RDS")
saveRDS(X3_final, "./Sim3/Sim3_X3_Y_outside.RDS")
saveRDS(Y_final, "./Sim3/Sim3_Y_Y_outside.RDS")

allLoadings = list(scores, loadings, timeLoadings)
saveRDS(allLoadings, "./Sim3/Sim3_input_loadings_Y_outside.RDS")

parameters = c(w_global1, w_global2, w_local1, w_local2, w_distinct1, w_distinct2, w_distinct3, noiseOnX, noiseOnY, Ysize)
saveRDS(parameters, "./Sim3/Sim3_parameters_Y_outside.RDS")
