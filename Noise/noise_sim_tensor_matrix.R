...
saveRDS(inputFac, "./noise_sim_tensor_matrix_inputFac.RDS")
saveRDS(inputFacnorm, "./noise_sim_tensor_matrix_inputFacnorm.RDS")

saveRDS(Z_010, "./noise_sim_tensor_matrix_Z_010.RDS")
saveRDS(Z_025, "./noise_sim_tensor_matrix_Z_025.RDS")
saveRDS(Z_035, "./noise_sim_tensor_matrix_Z_035.RDS")
saveRDS(Z_010_norm, "./noise_sim_tensor_matrix_Z_010_norm.RDS")
saveRDS(Z_025_norm, "./noise_sim_tensor_matrix_Z_025_norm.RDS")
saveRDS(Z_035_norm, "./noise_sim_tensor_matrix_Z_035_norm.RDS")

saveRDS(CMTF_010, "./noise_sim_tensor_matrix_CMTF_010.RDS")
saveRDS(CMTF_025, "./noise_sim_tensor_matrix_CMTF_025.RDS")
saveRDS(CMTF_035, "./noise_sim_tensor_matrix_CMTF_035.RDS")
saveRDS(CMTF_010_norm, "./noise_sim_tensor_matrix_CMTF_010_norm.RDS")
saveRDS(CMTF_025_norm, "./noise_sim_tensor_matrix_CMTF_025_norm.RDS")
saveRDS(CMTF_035_norm, "./noise_sim_tensor_matrix_CMTF_035_norm.RDS")
